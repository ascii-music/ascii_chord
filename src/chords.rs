...
pub static ALL_CHORDS: &'static [Chord] = &[
    ...
    Chord::new(&["A#", "Bb"], "x13331", &["A♯"], None, Some(BARRE_FRET1)),
    ...
    Chord::new(&["A#maj7", "Bbmaj7"], "x13231", &["A♯ raised 7ᵗʰ"], None, Some(BARRE_FRET1)),
    ...
    Chord::new(&["A#7", "Bb7"], "x13131", &["A♯ 7ᵗʰ"], None, Some(BARRE_FRET1)),
    Chord::new(&["A9"], "x02423", &["A 9ᵗʰ"], None, None),
    Chord::new(&["Am"], "x02210", &["A minor"], None, None),
    Chord::new(&["A#m", "Bbm"], "x13321", &["A♯ minor"], None, Some(BARRE_FRET1)),
    Chord::new(&["Am7"], "x02010", &["A minor 7ᵗʰ"], None, None),
    Chord::new(&["A#m7", "Bbm7"], "x13121", &["A♯ minor 7ᵗʰ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Asus"], "xx2230", &["A suspended"], None, None),
    Chord::new(&["Asus2"], "x02200", &["A suspended 2ⁿᵈ"], None, None),
    Chord::new(&["A#sus2", "Bbsus2"], "x13311", &["A♯ suspended 2ⁿᵈ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Asus4"], "x0223x", &["A suspended 4ᵗʰ"], None, None),
    Chord::new(&["A#sus4", "Bbsus4"], "x13341", &["A♯ suspended 4ᵗʰ"], None, Some(BARRE_FRET1)),
    Chord::new(&["A/C#", "A/Db"], "x4222x", &["A over C♯"], None, None),
    ...
    Chord::new(&["D#m7", "Ebm7"], "xx1322", &["D♯ minor 7ᵗʰ"], None, None),
    Chord::new(&["Dsus"], "xx0233", &["D suspended"], None, None),
    Chord::new(&["Dsus2"], "xx0120", &["D suspended 2ⁿᵈ"], None, None),
    Chord::new(&["D#sus2", "Ebsus2"], "xx1341", &["D♯ suspended 2ⁿᵈ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Dsus4"], "xx0233", &["D suspended 4ᵗʰ"], None, None),
    Chord::new(&["D#sus4", "Ebsus4"], "x02230", &["D♯ suspended 4ᵗʰ"], Some(CAPO_FRET6), None),
    Chord::new(&["D/A"], "x00232", &["D over A"], None, None),
    Chord::new(&["D/B"], "x20232", &["D over B"], None, None),
    Chord::new(&["D/F#", "D/Gb"], "2x0232", &["D over F♯"], None, None),
    ...
    Chord::new(&["E/C#", "E/Db"], "x42100", &["E over C♯"], None, None),
    Chord::new(&["F"], "133211", &["F"], None, Some(BARRE_FRET1)),
    Chord::new(&["F#", "Gb"], "244322", &["F♯"], None, Some(BARRE_FRET2)),
    ...
    Chord::new(&["F#m", "Gbm"], "244222", &["F♯ minor"], None, Some(BARRE_FRET2)),
    Chord::new(&["Fm7"], "131111", &["F minor 7ᵗʰ"], None, None),
    Chord::new(&["F#m7", "Gbm7"], "242222", &["F♯ minor 7ᵗʰ"], None, Some(BARRE_FRET2)),
    Chord::new(&["Fsus"], "xx3311", &["F suspended"], None, None),
    Chord::new(&["Fsus2"], "x02200", &["F suspended 2ⁿᵈ"], Some(CAPO_FRET8), None),
    Chord::new(&["F#sus2", "Gbsus2"], "2441xx", &["F♯ suspended 2ⁿᵈ"], None, None),
