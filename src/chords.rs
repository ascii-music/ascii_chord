...
use chord::{CAPO_FRET1, CAPO_FRET2, CAPO_FRET3, CAPO_FRET4, CAPO_FRET5, CAPO_FRET6};
...
pub static ALL_CHORDS: &'static [Chord] = &[
    ...
    Chord::new(&["C"], "x32010", &["C major"], None, None),
    Chord::new(&["C#"], "x02220", &["C sharp major"], Some(CAPO_FRET4), None),
    Chord::new(&["C+"], "x32110", &["C augmented"], None, None),
    Chord::new(&["Cmaj7"], "x32000", &["C major 7ᵗʰ"], None, None),
    ...
    Chord::new(&["C#m"], "x02210", &["C sharp minor"], Some(CAPO_FRET4), None),
    Chord::new(&["Cm7"], "x313xx", &["C minor 7ᵗʰ"], None, None),
    Chord::new(&["Csus"], "xx3013", &["C suspended"], None, None),
    Chord::new(&["D"], "xx0232", &["D major"], None, None),
    Chord::new(&["D#"], "x02220", &["D sharp major"], Some(CAPO_FRET6), None),
    Chord::new(&["D+"], "xx0332", &["D augmented"], None, None),
    Chord::new(&["Dmaj7"], "xx0222", &["D major 7ᵗʰ"], None, None),
    ...
    Chord::new(&["D#m"], "x02210", &["D sharp minor"], Some(CAPO_FRET6), None),
    Chord {
        short_names: &["Dm7", "F6"],
        pattern: "xx0211",
    ...
    Chord::new(&["E"], "022100", &["E major"], None, None),
    Chord::new(&["E+"], "03211x", &["E augmented"], None, None),
    Chord::new(&["Emaj7"], "021100", &["E major 7ᵗʰ"], None, None),
    ...
    Chord::new(&["F"], "133211", &["F major"], None, Some(BARRE_FRET1)),
    Chord::new(&["F#"], "244322", &["F sharp major"], None, Some(BARRE_FRET2)),
    Chord::new(&["F+"], "xx3221", &["F augmented"], None, None),
    Chord::new(&["Fmaj7"], "xx3210", &["F major 7ᵗʰ"], None, None),
    ...
    Chord::new(&["F#m"], "244222", &["F sharp minor"], None, Some(BARRE_FRET2)),
    Chord::new(&["Fm7"], "131111", &["F minor 7ᵗʰ"], None, None),
    Chord::new(&["Fsus"], "xx3311", &["F suspended"], None, None),
    Chord::new(&["G"], "320003", &["G major"], None, None),
    Chord::new(&["G#"], "022100", &["G sharp major"], Some(CAPO_FRET4), None),
    Chord::new(&["G+"], "321003", &["G augmented"], None, None),
    Chord::new(&["Gmaj7"], "3x0002", &["G major 7ᵗʰ"], None, None),
    ...
    Chord::new(&["G#m"], "022000", &["G sharp minor"], Some(CAPO_FRET4), None),
    Chord::new(&["Gm7"], "x13030", &["G minor 7ᵗʰ"], None, None),
