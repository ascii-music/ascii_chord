...
pub static ALL_CHORDS: &'static [Chord] = &[
    ...
    Chord::new(&["A#maj7", "Bbmaj7"], "x13231", &["A♯ raised 7ᵗʰ", "B♭ raised 7ᵗʰ"], None, Some(BARRE_FRET1)),
    ...
    Chord::new(&["A#m7", "Bbm7"], "x13121", &["A♯ minor 7ᵗʰ", "B♭ minor 7ᵗʰ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Asus"], "xx2230", &["A suspended"], None, None),
    Chord::new(&["Asus2"], "x02200", &["A suspended 2ⁿᵈ"], None, None),
    Chord::new(&["A#sus2", "Bbsus2"], "x13311", &["A♯ suspended 2ⁿᵈ", "B♭ suspended 2ⁿᵈ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Asus4"], "x0223x", &["A suspended 4ᵗʰ"], None, None),
    Chord::new(&["A#sus4", "Bbsus4"], "x13341", &["A♯ suspended 4ᵗʰ", "B♭ suspended 4ᵗʰ"], None, Some(BARRE_FRET1)),
    ...
    Chord::new(&["C#maj7", "Dbmaj7"], "x02120", &["C♯ raised 7ᵗʰ", "D♭ raised 7ᵗʰ"], Some(CAPO_FRET4), None),
    ...
    Chord::new(&["C#m7", "Dbm7"], "x02010", &["C♯ minor 7ᵗʰ", "D♭ minor 7ᵗʰ"], Some(CAPO_FRET4), None),
    Chord::new(&["Csus"], "xx3013", &["C suspended"], None, None),
    Chord::new(&["Csus2"], "x30013", &["C suspended 2ⁿᵈ"], None, None),
    Chord::new(&["C#sus2", "Dbsus2"], "x02200", &["C♯ suspended 2ⁿᵈ", "D♭ suspended 2ⁿᵈ"], Some(CAPO_FRET4), None),
    Chord::new(&["Csus4"], "x33011", &["C suspended 4ᵗʰ"], None, None),
    Chord::new(&["C#sus4", "Dbsus4"], "x02230", &["C♯ suspended 4ᵗʰ", "D♭ suspended 4ᵗʰ"], Some(CAPO_FRET4), None),
    ...
    Chord::new(&["D#sus2", "Ebsus2"], "xx1341", &["D♯ suspended 2ⁿᵈ", "E♭ suspended 2ⁿᵈ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Dsus4"], "xx0233", &["D suspended 4ᵗʰ"], None, None),
    Chord::new(&["D#sus4", "Ebsus4"], "x02230", &["D♯ suspended 4ᵗʰ", "E♭ suspended 4ᵗʰ"], Some(CAPO_FRET6), None),
    ...
    Chord::new(&["F#m7", "Gbm7"], "242222", &["F♯ minor 7ᵗʰ", "G♭ minor 7ᵗʰ"], None, Some(BARRE_FRET2)),
    Chord::new(&["Fsus"], "xx3311", &["F suspended"], None, None),
    Chord::new(&["Fsus2"], "x02200", &["F suspended 2ⁿᵈ"], Some(CAPO_FRET8), None),
    Chord::new(&["F#sus2", "Gbsus2"], "2441xx", &["F♯ suspended 2ⁿᵈ", "G♭ suspended 2ⁿᵈ"], None, None),
    Chord::new(&["Fsus4"], "133311", &["F suspended 4ᵗʰ"], None, Some(BARRE_FRET1)),
    Chord::new(&["F#sus4", "Gbsus4"], "244422", &["F♯ suspended 4ᵗʰ", "G♭ suspended 4ᵗʰ"], None, Some(BARRE_FRET2)),
    ...
    Chord::new(&["G#maj7", "Abmaj7"], "xx3210", &["G♯ raised 7ᵗʰ", "A♭ raised 7ᵗʰ"], Some(CAPO_FRET3), None),
    ...
    Chord::new(&["G#m7", "Abm7"], "020000", &["G♯ minor 7ᵗʰ", "A♭ minor 7ᵗʰ"], Some(CAPO_FRET4), None),
    Chord::new(&["Gsus"], "xx0013", &["G suspended"], None, None),
    Chord::new(&["Gsus2"], "300033", &["G suspended 2ⁿᵈ"], None, None),
    Chord::new(&["G#sus2", "Absus2"], "411144", &["G♯ suspended 2ⁿᵈ", "A♭ suspended 2ⁿᵈ"], None, Some(BARRE_FRET1)),
    Chord::new(&["Gsus4"], "330013", &["G suspended 4ᵗʰ"], None, None),
    Chord::new(&["G#sus4", "Absus4"], "022200", &["G♯ suspended 4ᵗʰ", "A♭ suspended 4ᵗʰ"], Some(CAPO_FRET4), None),
