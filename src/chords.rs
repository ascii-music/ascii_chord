...
pub static ALL_CHORDS: &'static [Chord] = &[
    ...
    Chord::new(&["A#"], "x13331", &["A♯ major"], None, Some(BARRE_FRET1)),
    ...
    Chord::new(&["C#"], "x02220", &["C♯ major"], Some(CAPO_FRET4), None),
    ...
    Chord::new(&["D#"], "x02220", &["D♯ major"], Some(CAPO_FRET6), None),
    ...
    Chord::new(&["F#"], "244322", &["F♯ major"], None, Some(BARRE_FRET2)),
    ...
    Chord::new(&["G#"], "022100", &["G ♯ major"], Some(CAPO_FRET4), None),
