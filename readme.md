...
Here is an example of using a [bar chord](https://en.wikipedia.org/wiki/Bar_chord) on the 1st fret for F and a [capo](https://en.wikipedia.org/wiki/Capo_(musical_device)) placed on the 4th fret for G#:
